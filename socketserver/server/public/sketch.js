...
function setup() {
  ...
  socket.on('setObject', function(data){
    r = data.presence.color.r;
    g = data.presence.color.g;
    b = data.presence.color.b;
  });
...
function draw() {
  ...
  directionalLight(r, g, b, dirX, -dirY, 0.01);
  ambientMaterial(255, 255, 255);

  var ambLightInrecrease = 60;
  ambientLight(
    min(r + ambLightInrecrease, 255),
    min(g + ambLightInrecrease, 255),
    min(b + ambLightInrecrease, 255));
